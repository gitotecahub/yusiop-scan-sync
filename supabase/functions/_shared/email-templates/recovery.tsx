...
export const RecoveryEmail = ({
  ...
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Restablece tu contraseña en YUSIOP</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Hemos recibido una solicitud para restablecer tu contraseña en YUSIOP. Haz clic en el botón para elegir una nueva.
        </Text>
        ...
        <Text style={footer}>
          Si no solicitaste el cambio, puedes ignorar este email. Tu contraseña no será modificada.
        </Text>
      </Container>
    </Body>
  </Html>
