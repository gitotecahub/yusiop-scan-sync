...
const es: Dict = {
  ...
  'artist.albumsTitle': 'Mis álbumes', 'artist.albumsDesc': 'Crear álbumes y EPs.',
...
const en: Dict = {
  ...
  'artist.albumsTitle': 'My albums', 'artist.albumsDesc': 'Create albums and EPs.',
...
const fr: Dict = {
  ...
  'home.anytime': 'À tout moment', 'home.topDownloaded': 'Plus téléchargée',
  'home.discoverRanking': 'Découvrez le classement', 'home.live': 'En direct',
  'home.receiveGifts': 'Recevez cadeaux', 'home.receiveGiftsDesc': 'Utilisez les codes de vos amis',
  'home.free': 'Gratuit', 'home.upcomingReleases': 'Sorties bientôt',
  'home.recsSoon': 'Recommandations bientôt', 'home.releasesSoon': 'Sorties bientôt',
  'home.noTrending': 'Pas encore de tendances',
  'catalog.searchPlaceholder': 'Rechercher titre, artiste ou album…',
  'catalog.balance': 'Votre solde', 'catalog.downloadsCardLabel': 'téléchargements · carte',
  'catalog.noCredits': 'Aucun crédit disponible', 'catalog.buyCard': 'Acheter une carte',
  'catalog.upcomingTitle': 'Prochaines sorties', 'catalog.comingSoonBadge': 'Prochainement',
  'catalog.purchaseSuccess': '🎉 Merci pour votre achat ! Votre carte sera disponible dans quelques secondes.',
  'catalog.noResultsFor': 'Aucun résultat pour',
  'catalog.subtitle': 'Découvrez et téléchargez votre musique préférée.',
  'catalog.errorNoCredits': "Vous n'avez pas de crédits. Scannez une carte QR pour en obtenir.",
  ...
  'store.messagePlaceholder': 'Profite de la musique !',
  'store.payButton': 'Payer', 'store.payAsGift': 'en cadeau',
  'store.simulate': "Simuler l'achat (sans paiement)",
  'store.simulateNote': 'Paiement sécurisé Stripe · La simulation crée la carte instantanément',
  'store.standardLabel': 'YUSIOP Standard', 'store.premiumLabel': 'YUSIOP Premium',
  'store.confirmingTitle': 'Confirmation de votre achat…',
  'store.confirmingDesc': 'Nous activons votre carte. Cela peut prendre quelques secondes.',
  'store.invalidEmail': 'Entrez un email valide pour le destinataire.',
  'store.errorStartPay': 'Erreur lors du paiement',
  'store.errorSimulate': "Erreur de simulation",
  'store.giftLinkCopied': '🎁 Cadeau créé. Lien copié dans le presse-papiers.',
  'cards.viewDetails': 'Voir détails de la carte',
  'cards.depleted': 'Supprimer carte épuisée', 'cards.deleteDepleted': 'Supprimer carte épuisée',
  'cards.giftCardTitle': 'Offrir carte',
  'cards.giftCardDesc': 'La carte sera transférée à la bibliothèque du destinataire. Cette action est irréversible.',
  'cards.recipientUsername': "Nom d'utilisateur du destinataire",
  'cards.giftPlaceholder': 'Pour que tu profites de la musique !',
  'cards.giftThis': 'Offrir cette carte',
  'cards.cardLabel': 'Carte', 'cards.downloadsLabel': 'Téléchargements',
  'cards.activatedLabel': 'Activée', 'cards.digital': 'Numérique', 'cards.physical': 'Physique',
  'cards.giftBadge': 'Cadeau', 'cards.codeCopied': 'Code copié dans le presse-papiers',
  'cards.copyError': 'Impossible de copier le code',
  'cards.removedFromLibrary': 'Carte supprimée de votre bibliothèque',
  'cards.enterUsername': "Entrez le nom d'utilisateur",
  'cards.giftError': 'Impossible d\'offrir la carte',
  'cards.giftSuccess': 'Carte offerte',
  'cards.sending': 'Envoi...', 'cards.confirmGift': 'Confirmer le cadeau',
  'cards.cardActivatedDate': 'Activée le',
  'cards.downloadsRemaining': 'Téléchargements restants',
  'cards.tapRedeem': 'Appuyez sur "Utiliser" pour activer la carte dans le scanner',
  'notif.markRead': 'Marquer lues', 'notif.empty2': 'Aucune notification',
  'player.nowPlaying': 'En cours', 'player.playing': 'Lecture en cours',
  'player.minimize': 'Réduire', 'player.share': 'Partager',
  'player.cast': 'Envoyer vers TV ou appareil',
  'player.castConnected': 'Connecté à', 'player.castAvailable': 'Appareils disponibles',
  'player.castConnecting': 'Connexion…', 'player.castSearch': 'Rechercher appareils',
  'player.shuffle': 'Aléatoire', 'player.previous': 'Précédent', 'player.next': 'Suivant',
  'player.repeat': 'Répéter', 'player.play': 'Lecture', 'player.pause': 'Pause',
  'player.fav': 'Ajouter aux favoris', 'player.unfav': 'Retirer des favoris',
  'player.linkCopied': 'Lien copié dans le presse-papiers',
  'player.shareError': 'Impossible de partager',
  'player.castNoDevices': "Aucun appareil détecté. Vérifiez que vous êtes sur le même Wi-Fi que votre TV ou Chromecast.",
  'player.castOpenError': 'Impossible d\'ouvrir le sélecteur',
  'player.disconnectedFrom': 'Déconnecté de',
  'player.localRestored': 'Lecture locale restaurée',
  'player.shareText': '🎵 Écoutez',
  'player.favAdded': 'Ajouté aux favoris', 'player.favRemoved': 'Retiré des favoris',
  'player.favError': 'Impossible de mettre à jour le favori',
  'player.loginToFav': 'Connectez-vous pour enregistrer les favoris',
  'player.errorPlayback': 'Impossible de lire l\'audio',
  'player.noAudio': 'Cette chanson n\'a pas de fichier audio',
  'player.errorStart': 'Impossible de démarrer la lecture',
  'player.errorPause': 'Impossible de mettre en pause',
  'artist.userMode': 'Mode Utilisateur', 'artist.welcomeEyebrow': 'Bienvenue',
  'artist.dashboardSubtitle': 'Gérez votre catalogue, téléversez de la musique et consultez les stats.',
  'artist.uploadMusic': 'Téléverser musique', 'artist.viewSubmissions': 'Mes envois',
  'artist.inReview': 'en révision',
  'artist.songsCardDesc': "Téléversez de nouvelles chansons et consultez l'état de vos envois.",
  'artist.albumsTitle': 'Mes albums', 'artist.albumsDesc': 'Créer albums et EPs.',
  'artist.statsCardTitle': 'Statistiques',
  'artist.statsCardDesc': 'Téléchargements, revenus, pays et démographie.',
  'artist.collabsCardDesc': 'Réclamez votre part de monétisation sur les chansons où vous figurez comme collaborateur.',
  'artist.noAccess': "Vous n'avez pas accès au panneau artiste.",
  'artist.requestProfile': "Demander un profil d'artiste",
  'artist.panelLabel': 'Panneau artiste', 'artist.statsLabel': 'Statistiques',
  'artist.audienceEyebrow': 'Votre audience',
  'artist.audienceSubtitle': "Téléchargements, revenus estimés et d'où on vous écoute.",
  'artist.totalDownloadsLabel': 'Téléchargements totaux',
  'artist.uniqueListeners': 'Auditeurs uniques',
  'artist.estIncome': 'Revenus estimés (votre part)',
  'artist.real': 'Réels', 'artist.realDesc': 'Génèrent des revenus',
  'artist.promo': 'Promotionnels', 'artist.promoDesc': 'Votre propre musique',
  'artist.suspicious': 'Suspects', 'artist.suspiciousDesc': 'Exclus des revenus',
  'artist.poolPending': 'En attente dans le pot commun (non réclamé)',
  'artist.poolDesc': 'téléchargements concernés',
  'artist.poolGoClaim': 'Aller réclamer',
  'artist.last30Days': '30 derniers jours',
  'artist.noDownloads30': 'Aucun téléchargement ces 30 derniers jours.',
  'artist.topSongs': 'Top chansons',
  'artist.noDownloadsYet': 'Pas encore de téléchargements.',
  'artist.countries': 'Pays', 'artist.top': 'Top',
  'artist.noGeo': 'Pas encore de données géographiques.',
  'artist.geoNote': "La localisation provient de l'IP au moment du téléchargement (approximative).",
  ...
  'artist.totalEstPending': 'Total estimé en attente',
  'artist.noPendingCollabs': 'Aucune collaboration en attente sous votre nom.',
  'artist.claimed': 'Réclamée', 'artist.claim': 'Réclamer',
  'artist.mySubmissionsRequests': 'Mes demandes',
  'artist.as': 'En tant que', 'artist.downloadsWord': 'téléchargements',
  'artist.estimated': 'estimé',
  'artist.errorLoadingPool': 'Erreur de chargement du pot',
  'artist.subsTitle': 'Chansons envoyées', 'artist.subsEyebrow': 'Mes envois',
  'artist.subsSubtitle': "Suivez l'état de révision de vos envois.",
  'artist.loading': 'Chargement…',
  'artist.noSongsSent': "Vous n'avez envoyé aucune chanson. Appuyez sur \"Téléverser musique\" pour commencer.",
  'artist.inReviewBadge': 'En révision', 'artist.scheduledBadge': 'Programmée',
  'artist.publishedBadge': 'Publiée', 'artist.rejectedBadge': 'Rejetée',
  'artist.removedBadge': 'Supprimée',
  'artist.editAndResend': 'Modifier et renvoyer',
  'artist.rejectionReasonsTitle': 'Votre sortie ne peut pas avoir lieu pour les raisons suivantes :',
  'artist.removedTitle': 'Votre chanson a été retirée du catalogue Yusiop',
  'artist.removedDesc': "L'équipe d'administration a retiré votre chanson du catalogue. Contactez le support pour plus d'infos.",
  'artist.scheduledTitle': 'Sortie programmée',
  'artist.scheduledDesc': 'sera publiée automatiquement le',
  'admin.management': 'Gestion', 'admin.backToApp': "Retour à l'app",
  'admin.signOut': 'Déconnexion', 'admin.signOutLabel': 'Déconnexion',
};
...
const pt: Dict = {
  ...
  'home.anytime': 'A qualquer momento', 'home.topDownloaded': 'Mais baixada',
  'home.discoverRanking': 'Descubra o ranking', 'home.live': 'Ao vivo',
  'home.receiveGifts': 'Receba presentes', 'home.receiveGiftsDesc': 'Resgate códigos dos amigos',
  'home.free': 'Grátis', 'home.upcomingReleases': 'Lançamentos em breve',
  'home.recsSoon': 'Recomendações em breve', 'home.releasesSoon': 'Lançamentos em breve',
  'home.noTrending': 'Sem tendências ainda',
  'catalog.searchPlaceholder': 'Buscar título, artista ou álbum…',
  'catalog.balance': 'Seu saldo', 'catalog.downloadsCardLabel': 'downloads · cartão',
  'catalog.noCredits': 'Sem créditos disponíveis', 'catalog.buyCard': 'Comprar cartão',
  'catalog.upcomingTitle': 'Próximos lançamentos', 'catalog.comingSoonBadge': 'Em breve',
  'catalog.purchaseSuccess': '🎉 Obrigado pela compra! Seu cartão estará disponível em segundos.',
  'catalog.noResultsFor': 'Sem resultados para',
  'catalog.subtitle': 'Descubra e baixe sua música favorita.',
  'catalog.errorNoCredits': 'Você não tem créditos. Escaneie um cartão QR.',
  ...
  'store.messagePlaceholder': 'Aproveite a música!',
  'store.payButton': 'Pagar', 'store.payAsGift': 'como presente',
  'store.simulate': 'Simular compra (sem pagamento)',
  'store.simulateNote': 'Pagamento seguro com Stripe · A simulação cria o cartão na hora',
  'store.standardLabel': 'YUSIOP Padrão', 'store.premiumLabel': 'YUSIOP Premium',
  'store.confirmingTitle': 'Confirmando sua compra…',
  'store.confirmingDesc': 'Estamos ativando seu cartão. Pode levar alguns segundos.',
  'store.invalidEmail': 'Digite um email válido para o destinatário.',
  'store.errorStartPay': 'Erro ao iniciar o pagamento',
  'store.errorSimulate': 'Erro ao simular compra',
  'store.giftLinkCopied': '🎁 Presente criado. Link copiado para a área de transferência.',
  'cards.viewDetails': 'Ver detalhes do cartão',
  'cards.depleted': 'Excluir cartão esgotado', 'cards.deleteDepleted': 'Excluir cartão esgotado',
  'cards.giftCardTitle': 'Presentear cartão',
  'cards.giftCardDesc': 'O cartão passará para a biblioteca do destinatário e sairá da sua. Esta ação não pode ser desfeita.',
  'cards.recipientUsername': 'Username do destinatário',
  'cards.giftPlaceholder': 'Para você aproveitar a música!',
  'cards.giftThis': 'Presentear este cartão',
  'cards.cardLabel': 'Cartão', 'cards.downloadsLabel': 'Downloads',
  'cards.activatedLabel': 'Ativado', 'cards.digital': 'Digital', 'cards.physical': 'Física',
  'cards.giftBadge': 'Presente', 'cards.codeCopied': 'Código copiado',
  'cards.copyError': 'Não foi possível copiar o código',
  'cards.removedFromLibrary': 'Cartão removido da sua biblioteca',
  'cards.enterUsername': 'Digite o username do destinatário',
  'cards.giftError': 'Não foi possível presentear o cartão',
  'cards.giftSuccess': 'Cartão presenteado',
  'cards.sending': 'Enviando...', 'cards.confirmGift': 'Confirmar presente',
  'cards.cardActivatedDate': 'Ativado em',
  'cards.downloadsRemaining': 'Downloads restantes',
  'cards.tapRedeem': 'Toque "Resgatar" para ativar o cartão no scanner',
  'notif.markRead': 'Marcar lidas', 'notif.empty2': 'Sem notificações',
  'player.nowPlaying': 'Tocando agora', 'player.playing': 'Reproduzindo',
  'player.minimize': 'Minimizar', 'player.share': 'Compartilhar',
  'player.cast': 'Enviar para TV ou dispositivo',
  'player.castConnected': 'Conectado a', 'player.castAvailable': 'Dispositivos disponíveis',
  'player.castConnecting': 'Conectando…', 'player.castSearch': 'Buscar dispositivos',
  'player.shuffle': 'Aleatório', 'player.previous': 'Anterior', 'player.next': 'Próxima',
  'player.repeat': 'Repetir', 'player.play': 'Reproduzir', 'player.pause': 'Pausar',
  'player.fav': 'Adicionar aos favoritos', 'player.unfav': 'Remover dos favoritos',
  'player.linkCopied': 'Link copiado',
  'player.shareError': 'Não foi possível compartilhar',
  'player.castNoDevices': 'Nenhum dispositivo encontrado. Verifique se está no mesmo Wi-Fi da TV ou Chromecast.',
  'player.castOpenError': 'Não foi possível abrir o seletor',
  'player.disconnectedFrom': 'Desconectado de',
  'player.localRestored': 'Reprodução local restaurada',
  'player.shareText': '🎵 Ouça',
  'player.favAdded': 'Adicionado aos favoritos', 'player.favRemoved': 'Removido dos favoritos',
  'player.favError': 'Não foi possível atualizar o favorito',
  'player.loginToFav': 'Entre para salvar favoritos',
  'player.errorPlayback': 'Não foi possível reproduzir',
  'player.noAudio': 'Esta música não tem arquivo de áudio',
  'player.errorStart': 'Não foi possível iniciar a reprodução',
  'player.errorPause': 'Não foi possível pausar',
  'artist.userMode': 'Modo Usuário', 'artist.welcomeEyebrow': 'Bem-vindo',
  'artist.dashboardSubtitle': 'Gerencie seu catálogo, envie música e veja estatísticas.',
  'artist.uploadMusic': 'Enviar música', 'artist.viewSubmissions': 'Meus envios',
  'artist.inReview': 'em revisão',
  'artist.songsCardDesc': 'Envie novas músicas e acompanhe o status dos envios.',
  'artist.albumsTitle': 'Meus álbuns', 'artist.albumsDesc': 'Criar álbuns e EPs.',
  'artist.statsCardTitle': 'Estatísticas',
  'artist.statsCardDesc': 'Downloads, receitas, países e demografia da audiência.',
  'artist.collabsCardDesc': 'Reivindique sua parte de monetização nas músicas em que você aparece como colaborador.',
  'artist.noAccess': 'Você não tem acesso ao painel do artista.',
  'artist.requestProfile': 'Solicitar perfil de artista',
  'artist.panelLabel': 'Painel artista', 'artist.statsLabel': 'Estatísticas',
  'artist.audienceEyebrow': 'Sua audiência',
  'artist.audienceSubtitle': 'Downloads, receitas estimadas e de onde te ouvem.',
  'artist.totalDownloadsLabel': 'Downloads totais',
  'artist.uniqueListeners': 'Ouvintes únicos',
  'artist.estIncome': 'Receita estimada (sua parte)',
  'artist.real': 'Reais', 'artist.realDesc': 'Geram receita',
  'artist.promo': 'Promocionais', 'artist.promoDesc': 'Sua própria música',
  'artist.suspicious': 'Suspeitas', 'artist.suspiciousDesc': 'Excluídas da receita',
  'artist.poolPending': 'Pendente no fundo comum (não reivindicado)',
  'artist.poolDesc': 'downloads afetados',
  'artist.poolGoClaim': 'Ir reivindicar',
  'artist.last30Days': 'Últimos 30 dias',
  'artist.noDownloads30': 'Sem downloads nos últimos 30 dias.',
  'artist.topSongs': 'Top músicas',
  'artist.noDownloadsYet': 'Ainda sem downloads.',
  'artist.countries': 'Países', 'artist.top': 'Top',
  'artist.noGeo': 'Sem dados geográficos ainda.',
  'artist.geoNote': 'A localização vem do IP no momento do download (aproximada).',
  ...
  'artist.totalEstPending': 'Total estimado pendente',
  'artist.noPendingCollabs': 'Sem colaborações pendentes no seu nome artístico.',
  'artist.claimed': 'Reivindicada', 'artist.claim': 'Reivindicar',
  'artist.mySubmissionsRequests': 'Minhas solicitações',
  'artist.as': 'Como', 'artist.downloadsWord': 'downloads',
  'artist.estimated': 'estimado',
  'artist.errorLoadingPool': 'Erro carregando fundo comum',
  'artist.subsTitle': 'Músicas enviadas', 'artist.subsEyebrow': 'Meus envios',
  'artist.subsSubtitle': 'Acompanhe o status de revisão dos seus envios.',
  'artist.loading': 'Carregando…',
  'artist.noSongsSent': 'Você ainda não enviou nenhuma música. Toque em "Enviar música" para começar.',
  'artist.inReviewBadge': 'Em revisão', 'artist.scheduledBadge': 'Programada',
  'artist.publishedBadge': 'Publicada', 'artist.rejectedBadge': 'Rejeitada',
  'artist.removedBadge': 'Removida',
  'artist.editAndResend': 'Editar e reenviar',
  'artist.rejectionReasonsTitle': 'Seu lançamento não pode prosseguir pelos seguintes motivos:',
  'artist.removedTitle': 'Sua música foi removida do catálogo Yusiop',
  'artist.removedDesc': 'A equipe de administração removeu sua música do catálogo. Entre em contato com o suporte para mais informações.',
  'artist.scheduledTitle': 'Lançamento programado',
  'artist.scheduledDesc': 'será publicada automaticamente em',
  'admin.management': 'Gestão', 'admin.backToApp': 'Voltar ao app',
  'admin.signOut': 'Sair', 'admin.signOutLabel': 'Sair',
};
...
const de: Dict = { ...en,
  ...
  'catalog.title': 'Katalog', 'catalog.search': 'Musik suchen...', 'catalog.popular': 'Beliebt',
  'library.title': 'Meine Bibliothek', 'library.empty': 'Du hast noch keine Musik',
  'qr.scan.title': 'QR scannen', 'qr.scan.instruction': 'QR-Code im Rahmen positionieren',
  'store.title': 'Shop', 'store.buy': 'Kaufen', 'store.gift': 'Geschenk',
  'settings.title': 'Einstellungen', 'settings.language': 'Sprache', 'settings.languageLabel': 'Sprache auswählen',
  'settings.country': 'Land', 'settings.countryLabel': 'Dein Land oder Region',
  'settings.currency': 'Währung', 'settings.currencyLabel': 'Anzeige-Währung',
  'settings.detectAuto': 'Automatisch erkennen', 'settings.localeSaved': 'Einstellungen gespeichert',
  'settings.theme': 'Design', 'settings.notifications': 'Benachrichtigungen',
  'action.play': 'Abspielen', 'action.download': 'Herunterladen', 'action.share': 'Teilen', 'action.gift': 'Geschenk',
...
const it: Dict = { ...en,
  ...
  'catalog.title': 'Catalogo', 'catalog.search': 'Cerca musica...', 'catalog.popular': 'Popolare',
  'library.title': 'La mia libreria', 'library.empty': 'Non hai ancora musica',
  'qr.scan.title': 'Scansiona QR', 'qr.scan.instruction': 'Posiziona il codice QR nel riquadro',
  'store.title': 'Negozio', 'store.buy': 'Acquista', 'store.gift': 'Regalo',
  'settings.title': 'Impostazioni', 'settings.language': 'Lingua', 'settings.languageLabel': 'Seleziona lingua',
  'settings.country': 'Paese', 'settings.countryLabel': 'Il tuo paese o regione',
  'settings.currency': 'Valuta', 'settings.currencyLabel': 'Valuta per i prezzi',
  'settings.detectAuto': 'Rileva automaticamente', 'settings.localeSaved': 'Preferenze salvate',
  'settings.theme': 'Tema', 'settings.notifications': 'Notifiche',
  'action.play': 'Riproduci', 'action.download': 'Scarica', 'action.share': 'Condividi', 'action.gift': 'Regala',
  'auth.signin': 'Accedi', 'auth.signup': 'Registrati', 'auth.email': 'Email', 'auth.password': 'Password',
};
...
const nl: Dict = { ...en,
  ...
  'catalog.title': 'Catalogus', 'catalog.search': 'Zoek muziek...', 'catalog.popular': 'Populair',
  'library.title': 'Mijn bibliotheek', 'library.empty': 'Je hebt nog geen muziek',
  'qr.scan.title': 'Scan QR', 'qr.scan.instruction': 'Positioneer QR-code in het kader',
  'store.title': 'Winkel', 'store.buy': 'Kopen', 'store.gift': 'Cadeau',
  'settings.title': 'Instellingen', 'settings.language': 'Taal', 'settings.languageLabel': 'Selecteer taal',
  'settings.country': 'Land', 'settings.countryLabel': 'Jouw land of regio',
  'settings.currency': 'Valuta', 'settings.currencyLabel': 'Weergavevaluta',
  'settings.detectAuto': 'Automatisch detecteren', 'settings.localeSaved': 'Voorkeuren opgeslagen',
  'settings.theme': 'Thema', 'settings.notifications': 'Meldingen',
  'action.play': 'Afspelen', 'action.download': 'Downloaden', 'action.share': 'Delen', 'action.gift': 'Cadeau geven',
  'auth.signin': 'Inloggen', 'auth.signup': 'Aanmelden', 'auth.email': 'E-mail', 'auth.password': 'Wachtwoord',
};

const pl: Dict = { ...en,
  'nav.home': 'Start', 'nav.qr': 'QR', 'nav.catalog': 'Katalog', 'nav.library': 'Biblioteka', 'nav.profile': 'Profil',
  'home.hero.title': 'Twoja muzyka\nw wysokiej jakości', 'home.hero.subtitle': 'Skanuj, odkrywaj i kolekcjonuj. Brzmienie stworzone dla Ciebie.',
  'home.hero.scan': 'Skanuj kartę', 'home.hero.explore': 'Odkrywaj',
  'profile.title': 'Mój profil', 'profile.cards': 'Moje karty', 'profile.history': 'Historia', 'profile.settings': 'Ustawienia',
  'profile.logout': 'Wyloguj', 'profile.artistMode': 'Tryb artysty',
  'catalog.title': 'Katalog', 'catalog.search': 'Szukaj muzyki...', 'catalog.popular': 'Popularne',
  'library.title': 'Moja biblioteka', 'library.empty': 'Nie masz jeszcze muzyki',
  'qr.scan.title': 'Skanuj QR', 'qr.scan.instruction': 'Umieść kod QR w ramce',
  'store.title': 'Sklep', 'store.buy': 'Kup', 'store.gift': 'Prezent',
  'settings.title': 'Ustawienia', 'settings.language': 'Język', 'settings.languageLabel': 'Wybierz język',
  'settings.country': 'Kraj', 'settings.countryLabel': 'Twój kraj lub region',
  'settings.currency': 'Waluta', 'settings.currencyLabel': 'Waluta wyświetlania',
  'settings.detectAuto': 'Wykryj automatycznie', 'settings.localeSaved': 'Preferencje zapisane',
  'settings.theme': 'Motyw', 'settings.notifications': 'Powiadomienia',
  'action.play': 'Odtwórz', 'action.download': 'Pobierz', 'action.share': 'Udostępnij', 'action.gift': 'Prezent',
  'auth.signin': 'Zaloguj', 'auth.signup': 'Zarejestruj', 'auth.email': 'Email', 'auth.password': 'Hasło',
};

const ru: Dict = { ...en,
  'nav.home': 'Главная', 'nav.qr': 'QR', 'nav.catalog': 'Каталог', 'nav.library': 'Библиотека', 'nav.profile': 'Профиль',
  'home.hero.title': 'Ваша музыка\nв высоком качестве', 'home.hero.subtitle': 'Сканируйте, открывайте и собирайте. Звуковой опыт создан для вас.',
  'home.hero.scan': 'Сканировать', 'home.hero.explore': 'Исследовать',
  'profile.title': 'Мой профиль', 'profile.cards': 'Мои карты', 'profile.history': 'История', 'profile.settings': 'Настройки',
  'profile.logout': 'Выйти', 'profile.artistMode': 'Режим артиста',
  'catalog.title': 'Каталог', 'catalog.search': 'Поиск музыки...', 'catalog.popular': 'Популярное',
  'library.title': 'Моя библиотека', 'library.empty': 'У вас пока нет музыки',
  'qr.scan.title': 'Сканировать QR', 'qr.scan.instruction': 'Поместите QR-код в рамку',
  'store.title': 'Магазин', 'store.buy': 'Купить', 'store.gift': 'Подарок',
  'settings.title': 'Настройки', 'settings.language': 'Язык', 'settings.languageLabel': 'Выберите язык',
  'settings.country': 'Страна', 'settings.countryLabel': 'Ваша страна или регион',
  'settings.currency': 'Валюта', 'settings.currencyLabel': 'Валюта отображения',
  'settings.detectAuto': 'Определить автоматически', 'settings.localeSaved': 'Настройки сохранены',
  'settings.theme': 'Тема', 'settings.notifications': 'Уведомления',
  'action.play': 'Играть', 'action.download': 'Скачать', 'action.share': 'Поделиться', 'action.gift': 'Подарить',
  'auth.signin': 'Войти', 'auth.signup': 'Регистрация', 'auth.email': 'Email', 'auth.password': 'Пароль',
};

const zh: Dict = { ...en,
  'nav.home': '首页', 'nav.qr': 'QR', 'nav.catalog': '目录', 'nav.library': '图书馆', 'nav.profile': '个人资料',
  'home.hero.title': '你的音乐\n高保真音质', 'home.hero.subtitle': '扫描、发现、收藏。为你量身打造的听觉体验。',
  'home.hero.scan': '扫描卡片', 'home.hero.explore': '探索音乐',
  'profile.title': '我的资料', 'profile.cards': '我的卡片', 'profile.history': '历史', 'profile.settings': '设置',
  'profile.logout': '退出', 'profile.artistMode': '艺术家模式',
  'catalog.title': '目录', 'catalog.search': '搜索音乐...', 'catalog.popular': '热门',
  'library.title': '我的图书馆', 'library.empty': '你还没有音乐',
  'qr.scan.title': '扫描二维码', 'qr.scan.instruction': '将二维码对准框内',
  'store.title': '商店', 'store.buy': '购买', 'store.gift': '礼物',
  'settings.title': '设置', 'settings.language': '语言', 'settings.languageLabel': '选择语言',
  'settings.country': '国家', 'settings.countryLabel': '您的国家或地区',
  'settings.currency': '货币', 'settings.currencyLabel': '显示货币',
  'settings.detectAuto': '自动检测', 'settings.localeSaved': '偏好已保存',
  'settings.theme': '主题', 'settings.notifications': '通知',
  'action.play': '播放', 'action.download': '下载', 'action.share': '分享', 'action.gift': '赠送',
  'auth.signin': '登录', 'auth.signup': '注册', 'auth.email': '邮箱', 'auth.password': '密码',
};

const ja: Dict = { ...en,
  'nav.home': 'ホーム', 'nav.qr': 'QR', 'nav.catalog': 'カタログ', 'nav.library': 'ライブラリ', 'nav.profile': 'プロフィール',
  'home.hero.title': 'あなたの音楽を\n高音質で', 'home.hero.subtitle': 'スキャンして、発見して、コレクションする。あなたのための音体験。',
  'home.hero.scan': 'カードをスキャン', 'home.hero.explore': '音楽を探す',
  'profile.title': 'マイプロフィール', 'profile.cards': 'マイカード', 'profile.history': '履歴', 'profile.settings': '設定',
  'profile.logout': 'ログアウト', 'profile.artistMode': 'アーティストモード',
  'catalog.title': 'カタログ', 'catalog.search': '音楽を検索...', 'catalog.popular': '人気',
  'library.title': 'マイライブラリ', 'library.empty': 'まだ音楽がありません',
  'qr.scan.title': 'QRをスキャン', 'qr.scan.instruction': 'QRコードを枠内に配置',
  'store.title': 'ストア', 'store.buy': '購入', 'store.gift': 'ギフト',
  'settings.title': '設定', 'settings.language': '言語', 'settings.languageLabel': '言語を選択',
  'settings.country': '国', 'settings.countryLabel': 'あなたの国または地域',
  'settings.currency': '通貨', 'settings.currencyLabel': '表示通貨',
  'settings.detectAuto': '自動検出', 'settings.localeSaved': '設定を保存しました',
  'settings.theme': 'テーマ', 'settings.notifications': '通知',
  'action.play': '再生', 'action.download': 'ダウンロード', 'action.share': '共有', 'action.gift': 'ギフト',
  'auth.signin': 'ログイン', 'auth.signup': '新規登録', 'auth.email': 'メール', 'auth.password': 'パスワード',
};

const ko: Dict = { ...en,
  'nav.home': '홈', 'nav.qr': 'QR', 'nav.catalog': '카탈로그', 'nav.library': '라이브러리', 'nav.profile': '프로필',
  'home.hero.title': '당신의 음악을\n고음질로', 'home.hero.subtitle': '스캔하고, 발견하고, 수집하세요. 당신을 위한 사운드 경험.',
  'home.hero.scan': '카드 스캔', 'home.hero.explore': '음악 탐색',
  'profile.title': '내 프로필', 'profile.cards': '내 카드', 'profile.history': '기록', 'profile.settings': '설정',
  'profile.logout': '로그아웃', 'profile.artistMode': '아티스트 모드',
  'catalog.title': '카탈로그', 'catalog.search': '음악 검색...', 'catalog.popular': '인기',
  'library.title': '내 라이브러리', 'library.empty': '아직 음악이 없습니다',
  'qr.scan.title': 'QR 스캔', 'qr.scan.instruction': 'QR 코드를 프레임에 맞추세요',
  'store.title': '스토어', 'store.buy': '구매', 'store.gift': '선물',
  'settings.title': '설정', 'settings.language': '언어', 'settings.languageLabel': '언어 선택',
  'settings.country': '국가', 'settings.countryLabel': '당신의 국가 또는 지역',
  'settings.currency': '통화', 'settings.currencyLabel': '표시 통화',
  'settings.detectAuto': '자동 감지', 'settings.localeSaved': '설정이 저장됨',
  'settings.theme': '테마', 'settings.notifications': '알림',
  'action.play': '재생', 'action.download': '다운로드', 'action.share': '공유', 'action.gift': '선물',
  'auth.signin': '로그인', 'auth.signup': '가입', 'auth.email': '이메일', 'auth.password': '비밀번호',
};

const ar: Dict = { ...en,
  'nav.home': 'الرئيسية', 'nav.qr': 'QR', 'nav.catalog': 'الكتالوج', 'nav.library': 'المكتبة', 'nav.profile': 'الملف الشخصي',
  'home.hero.title': 'موسيقاك\nبجودة عالية', 'home.hero.subtitle': 'امسح، اكتشف، واجمع. تجربة صوتية مصممة لك.',
  'home.hero.scan': 'مسح البطاقة', 'home.hero.explore': 'استكشف الموسيقى',
  'profile.title': 'ملفي الشخصي', 'profile.cards': 'بطاقاتي', 'profile.history': 'السجل', 'profile.settings': 'الإعدادات',
  'profile.logout': 'تسجيل الخروج', 'profile.artistMode': 'وضع الفنان',
  'catalog.title': 'الكتالوج', 'catalog.search': 'البحث عن موسيقى...', 'catalog.popular': 'الأكثر شيوعاً',
  'library.title': 'مكتبتي', 'library.empty': 'ليس لديك موسيقى بعد',
  'qr.scan.title': 'مسح QR', 'qr.scan.instruction': 'ضع رمز QR في الإطار',
  'store.title': 'المتجر', 'store.buy': 'شراء', 'store.gift': 'هدية',
  'settings.title': 'الإعدادات', 'settings.language': 'اللغة', 'settings.languageLabel': 'اختر اللغة',
  'settings.country': 'الدولة', 'settings.countryLabel': 'بلدك أو منطقتك',
  'settings.currency': 'العملة', 'settings.currencyLabel': 'عملة العرض',
  'settings.detectAuto': 'كشف تلقائي', 'settings.localeSaved': 'تم حفظ التفضيلات',
  'settings.theme': 'المظهر', 'settings.notifications': 'الإشعارات',
  'action.play': 'تشغيل', 'action.download': 'تحميل', 'action.share': 'مشاركة', 'action.gift': 'إهداء',
  'auth.signin': 'تسجيل الدخول', 'auth.signup': 'إنشاء حساب', 'auth.email': 'البريد', 'auth.password': 'كلمة المرور',
};

const hi: Dict = { ...en,
  'nav.home': 'होम', 'nav.qr': 'QR', 'nav.catalog': 'कैटलॉग', 'nav.library': 'लाइब्रेरी', 'nav.profile': 'प्रोफाइल',
  'home.hero.title': 'आपका संगीत\nउच्च गुणवत्ता में', 'home.hero.subtitle': 'स्कैन करें, खोजें और संग्रहित करें। आपके लिए बना ध्वनि अनुभव।',
  'home.hero.scan': 'कार्ड स्कैन करें', 'home.hero.explore': 'संगीत खोजें',
  'profile.title': 'मेरा प्रोफाइल', 'profile.cards': 'मेरे कार्ड', 'profile.history': 'इतिहास', 'profile.settings': 'सेटिंग्स',
  'profile.logout': 'लॉग आउट', 'profile.artistMode': 'कलाकार मोड',
  'catalog.title': 'कैटलॉग', 'catalog.search': 'संगीत खोजें...', 'catalog.popular': 'लोकप्रिय',
  'library.title': 'मेरी लाइब्रेरी', 'library.empty': 'अभी तक कोई संगीत नहीं',
  'qr.scan.title': 'QR स्कैन करें', 'qr.scan.instruction': 'QR कोड को फ्रेम में रखें',
  'store.title': 'स्टोर', 'store.buy': 'खरीदें', 'store.gift': 'उपहार',
  'settings.title': 'सेटिंग्स', 'settings.language': 'भाषा', 'settings.languageLabel': 'भाषा चुनें',
  'settings.country': 'देश', 'settings.countryLabel': 'आपका देश या क्षेत्र',
  'settings.currency': 'मुद्रा', 'settings.currencyLabel': 'प्रदर्शन मुद्रा',
  'settings.detectAuto': 'स्वतः पहचान', 'settings.localeSaved': 'प्राथमिकताएं सहेजी गईं',
  'settings.theme': 'थीम', 'settings.notifications': 'सूचनाएं',
  'action.play': 'चलाएं', 'action.download': 'डाउनलोड', 'action.share': 'साझा करें', 'action.gift': 'उपहार',
  'auth.signin': 'लॉग इन', 'auth.signup': 'साइन अप', 'auth.email': 'ईमेल', 'auth.password': 'पासवर्ड',
};

const tr: Dict = { ...en,
  'nav.home': 'Ana Sayfa', 'nav.qr': 'QR', 'nav.catalog': 'Katalog', 'nav.library': 'Kütüphane', 'nav.profile': 'Profil',
  'home.hero.title': 'Müziğiniz\nyüksek kalitede', 'home.hero.subtitle': 'Tarama, keşif ve koleksiyon. Sizin için tasarlanmış bir ses deneyimi.',
  'home.hero.scan': 'Kartı Tara', 'home.hero.explore': 'Müzik Keşfet',
  'profile.title': 'Profilim', 'profile.cards': 'Kartlarım', 'profile.history': 'Geçmiş', 'profile.settings': 'Ayarlar',
  'profile.logout': 'Çıkış', 'profile.artistMode': 'Sanatçı Modu',
  'catalog.title': 'Katalog', 'catalog.search': 'Müzik ara...', 'catalog.popular': 'Popüler',
  'library.title': 'Kütüphanem', 'library.empty': 'Henüz müziğiniz yok',
  'qr.scan.title': 'QR Tara', 'qr.scan.instruction': 'QR kodu çerçeveye yerleştirin',
  'store.title': 'Mağaza', 'store.buy': 'Satın Al', 'store.gift': 'Hediye',
  'settings.title': 'Ayarlar', 'settings.language': 'Dil', 'settings.languageLabel': 'Dil seçin',
  'settings.country': 'Ülke', 'settings.countryLabel': 'Ülke veya bölgeniz',
  'settings.currency': 'Para birimi', 'settings.currencyLabel': 'Görüntüleme para birimi',
  'settings.detectAuto': 'Otomatik algıla', 'settings.localeSaved': 'Tercihler kaydedildi',
  'settings.theme': 'Tema', 'settings.notifications': 'Bildirimler',
  'action.play': 'Oynat', 'action.download': 'İndir', 'action.share': 'Paylaş', 'action.gift': 'Hediye Et',
  'auth.signin': 'Giriş', 'auth.signup': 'Kaydol', 'auth.email': 'E-posta', 'auth.password': 'Şifre',
};

const sv: Dict = { ...en,
  'nav.home': 'Hem', 'nav.qr': 'QR', 'nav.catalog': 'Katalog', 'nav.library': 'Bibliotek', 'nav.profile': 'Profil',
  'home.hero.title': 'Din musik\ni hög kvalitet', 'home.hero.subtitle': 'Skanna, upptäck och samla. En ljudupplevelse skapad för dig.',
  'home.hero.scan': 'Skanna kort', 'home.hero.explore': 'Utforska musik',
  'profile.title': 'Min profil', 'profile.cards': 'Mina kort', 'profile.history': 'Historik', 'profile.settings': 'Inställningar',
  'profile.logout': 'Logga ut', 'profile.artistMode': 'Artistläge',
  'catalog.title': 'Katalog', 'catalog.search': 'Sök musik...', 'catalog.popular': 'Populär',
  'library.title': 'Mitt bibliotek', 'library.empty': 'Du har ingen musik än',
  'qr.scan.title': 'Skanna QR', 'qr.scan.instruction': 'Placera QR-koden i ramen',
  'store.title': 'Butik', 'store.buy': 'Köp', 'store.gift': 'Present',
  'settings.title': 'Inställningar', 'settings.language': 'Språk', 'settings.languageLabel': 'Välj språk',
  'settings.country': 'Land', 'settings.countryLabel': 'Ditt land eller region',
  'settings.currency': 'Valuta', 'settings.currencyLabel': 'Visningsvaluta',
  'settings.detectAuto': 'Identifiera automatiskt', 'settings.localeSaved': 'Inställningar sparade',
  'settings.theme': 'Tema', 'settings.notifications': 'Aviseringar',
  'action.play': 'Spela', 'action.download': 'Ladda ner', 'action.share': 'Dela', 'action.gift': 'Ge bort',
  'auth.signin': 'Logga in', 'auth.signup': 'Registrera', 'auth.email': 'E-post', 'auth.password': 'Lösenord',
};

const da: Dict = { ...en,
  'nav.home': 'Hjem', 'nav.qr': 'QR', 'nav.catalog': 'Katalog', 'nav.library': 'Bibliotek', 'nav.profile': 'Profil',
  'home.hero.title': 'Din musik\ni høj kvalitet', 'home.hero.subtitle': 'Scan, opdag og samle. En lydoplevelse lavet til dig.',
  'home.hero.scan': 'Scan kort', 'home.hero.explore': 'Udforsk musik',
  'profile.title': 'Min profil', 'profile.cards': 'Mine kort', 'profile.history': 'Historik', 'profile.settings': 'Indstillinger',
  'profile.logout': 'Log ud', 'profile.artistMode': 'Kunstner tilstand',
  'catalog.title': 'Katalog', 'catalog.search': 'Søg musik...', 'catalog.popular': 'Populær',
  'library.title': 'Mit bibliotek', 'library.empty': 'Du har ingen musik endnu',
  'qr.scan.title': 'Scan QR', 'qr.scan.instruction': 'Placer QR-koden i rammen',
  'store.title': 'Butik', 'store.buy': 'Køb', 'store.gift': 'Gave',
  'settings.title': 'Indstillinger', 'settings.language': 'Sprog', 'settings.languageLabel': 'Vælg sprog',
  'settings.country': 'Land', 'settings.countryLabel': 'Dit land eller region',
  'settings.currency': 'Valuta', 'settings.currencyLabel': 'Visningsvaluta',
  'settings.detectAuto': 'Find automatisk', 'settings.localeSaved': 'Indstillinger gemt',
  'settings.theme': 'Tema', 'settings.notifications': 'Notifikationer',
  'action.play': 'Afspil', 'action.download': 'Download', 'action.share': 'Del', 'action.gift': 'Giv gave',
  'auth.signin': 'Log ind', 'auth.signup': 'Tilmeld', 'auth.email': 'Email', 'auth.password': 'Adgangskode',
};

const no: Dict = { ...en,
  'nav.home': 'Hjem', 'nav.qr': 'QR', 'nav.catalog': 'Katalog', 'nav.library': 'Bibliotek', 'nav.profile': 'Profil',
  'home.hero.title': 'Musikken din\ni høy kvalitet', 'home.hero.subtitle': 'Skann, oppdag og samle. En lydopplevelse laget for deg.',
  'home.hero.scan': 'Skann kort', 'home.hero.explore': 'Utforsk musikk',
  'profile.title': 'Min profil', 'profile.cards': 'Mine kort', 'profile.history': 'Historikk', 'profile.settings': 'Innstillinger',
  'profile.logout': 'Logg ut', 'profile.artistMode': 'Artist-modus',
  'catalog.title': 'Katalog', 'catalog.search': 'Søk musikk...', 'catalog.popular': 'Populær',
  'library.title': 'Biblioteket mitt', 'library.empty': 'Du har ingen musikk ennå',
  'qr.scan.title': 'Skann QR', 'qr.scan.instruction': 'Plasser QR-koden i rammen',
  'store.title': 'Butikk', 'store.buy': 'Kjøp', 'store.gift': 'Gave',
  'settings.title': 'Innstillinger', 'settings.language': 'Språk', 'settings.languageLabel': 'Velg språk',
  'settings.country': 'Land', 'settings.countryLabel': 'Ditt land eller region',
  'settings.currency': 'Valuta', 'settings.currencyLabel': 'Visningsvaluta',
  'settings.detectAuto': 'Oppdag automatisk', 'settings.localeSaved': 'Innstillinger lagret',
  'settings.theme': 'Tema', 'settings.notifications': 'Varsler',
  'action.play': 'Spill', 'action.download': 'Last ned', 'action.share': 'Del', 'action.gift': 'Gi gave',
  'auth.signin': 'Logg inn', 'auth.signup': 'Registrer', 'auth.email': 'E-post', 'auth.password': 'Passord',
};

const fi: Dict = { ...en,
  'nav.home': 'Koti', 'nav.qr': 'QR', 'nav.catalog': 'Luettelo', 'nav.library': 'Kirjasto', 'nav.profile': 'Profiili',
  'home.hero.title': 'Musiikkisi\nkorkealaatuisena', 'home.hero.subtitle': 'Skannaa, löydä ja kerää. Sinulle tehty äänielämys.',
  'home.hero.scan': 'Skannaa kortti', 'home.hero.explore': 'Tutki musiikkia',
  'profile.title': 'Profiilini', 'profile.cards': 'Korttini', 'profile.history': 'Historia', 'profile.settings': 'Asetukset',
  'profile.logout': 'Kirjaudu ulos', 'profile.artistMode': 'Taiteila-tila',
  'catalog.title': 'Luettelo', 'catalog.search': 'Hae musiikkia...', 'catalog.popular': 'Suosittu',
  'library.title': 'Kirjastoni', 'library.empty': 'Sinulla ei ole vielä musiikkia',
  'qr.scan.title': 'Skannaa QR', 'qr.scan.instruction': 'Aseta QR-koodi kehykseen',
  'store.title': 'Kauppa', 'store.buy': 'Osta', 'store.gift': 'Lahja',
  'settings.title': 'Asetukset', 'settings.language': 'Kieli', 'settings.languageLabel': 'Valitse kieli',
  'settings.country': 'Maa', 'settings.countryLabel': 'Maasi tai alueesi',
  'settings.currency': 'Valuutta', 'settings.currencyLabel': 'Näyttövaluutta',
  'settings.detectAuto': 'Tunnista automaattisesti', 'settings.localeSaved': 'Asetukset tallennettu',
  'settings.theme': 'Teema', 'settings.notifications': 'Ilmoitukset',
  'action.play': 'Toista', 'action.download': 'Lataa', 'action.share': 'Jaa', 'action.gift': 'Lahjoita',
  'auth.signin': 'Kirjaudu', 'auth.signup': 'Rekisteröidy', 'auth.email': 'Sähköposti', 'auth.password': 'Salasana',
};

const el: Dict = { ...en,
  'nav.home': 'Αρχική', 'nav.qr': 'QR', 'nav.catalog': 'Κατάλογος', 'nav.library': 'Βιβλιοθήκη', 'nav.profile': 'Προφίλ',
  'home.hero.title': 'Η μουσική σου\nσε υψηλή ποιότητα', 'home.hero.subtitle': 'Σάρωση, ανακάλυψη και συλλογή. Μια ηχητική εμπειρία φτιαγμένη για εσένα.',
  'home.hero.scan': 'Σάρωση κάρτας', 'home.hero.explore': 'Εξερεύνησε',
  'profile.title': 'Το προφίλ μου', 'profile.cards': 'Οι κάρτες μου', 'profile.history': 'Ιστορικό', 'profile.settings': 'Ρυθμίσεις',
  'profile.logout': 'Αποσύνδεση', 'profile.artistMode': 'Λειτουργία καλλιτέχνη',
  'catalog.title': 'Κατάλογος', 'catalog.search': 'Αναζήτηση μουσικής...', 'catalog.popular': 'Δημοφιλή',
  'library.title': 'Η βιβλιοθήκη μου', 'library.empty': 'Δεν έχεις ακόμα μουσική',
  'qr.scan.title': 'Σάρωση QR', 'qr.scan.instruction': 'Τοποθετήστε τον κωδικό QR στο πλαίσιο',
  'store.title': 'Κατάστημα', 'store.buy': 'Αγορά', 'store.gift': 'Δώρο',
  'settings.title': 'Ρυθμίσεις', 'settings.language': 'Γλώσσα', 'settings.languageLabel': 'Επίλεξε γλώσσα',
  'settings.country': 'Χώρα', 'settings.countryLabel': 'Η χώρα ή η περιοχή σου',
  'settings.currency': 'Νόμισμα', 'settings.currencyLabel': 'Νόμισμα εμφάνισης',
  'settings.detectAuto': 'Αυτόματη ανίχνευση', 'settings.localeSaved': 'Οι προτιμήσεις αποθηκεύτηκαν',
  'settings.theme': 'Θέμα', 'settings.notifications': 'Ειδοποιήσεις',
  'action.play': 'Αναπαραγωγή', 'action.download': 'Λήψη', 'action.share': 'Κοινοποίηση', 'action.gift': 'Δώρο',
  'auth.signin': 'Σύνδεση', 'auth.signup': 'Εγγραφή', 'auth.email': 'Email', 'auth.password': 'Κωδικός',
};

export const translations: Record<Language, Dict> = { es, en, fr, pt, de, it, nl, pl, ru, zh, ja, ko, ar, hi, tr, sv, da, no, fi, el };
