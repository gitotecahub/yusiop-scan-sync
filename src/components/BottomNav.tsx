...
const BottomNav = () => {
  ...
  return (
    <div className={cn("absolute bottom-0 left-0 right-0 z-40 flex items-center justify-around p-2 bg-background/95 backdrop-blur-sm border-t border-border/50", location.pathname === '/catalog' ? 'translate-y-[8px]' : 'translate-y-[3px]')}>
      {navItems.map((item) => {
