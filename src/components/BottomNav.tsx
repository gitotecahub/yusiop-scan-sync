...
const BottomNav = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-40 flex items-center justify-around p-2 bg-background/95 backdrop-blur-sm border-t border-border/50 translate-y-[3px]">
      {navItems.map((item) => {
