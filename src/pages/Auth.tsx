        ...
        <div className="glass-strong shadow-vapor p-7">
          ...
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'signin' | 'signup')} className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-card/40 border border-border rounded-full p-1 h-auto gap-1 mb-6">
              <TabsTrigger
                value="signin"
                className="rounded-full data-[state=active]:vapor-bg data-[state=active]:text-white data-[state=active]:shadow-glow py-2.5 text-xs font-bold tracking-wide"
              >
                {t('auth.signin')}
              </TabsTrigger>
              <TabsTrigger
            ...
            <TabsContent value="signin" className="space-y-4">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <Button type="submit" className="w-full h-12 rounded-full vapor-bg text-white hover:opacity-90 font-bold shadow-glow" disabled={loading}>
