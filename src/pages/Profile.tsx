      ...
      <div className="blob-card p-6">
        ...
        {editing && (
          <div className="space-y-4 mt-6 pt-6 border-t border-border">
            ...
            <Button onClick={handleSaveProfile} className="w-full rounded-full vapor-bg text-white hover:opacity-90 h-11 font-bold shadow-glow">
              {t('profile.save')}
            </Button>
          </div>
        )}
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <Button
                ...
                className="mt-3 rounded-full vapor-bg text-white h-9 px-4 text-xs font-bold shadow-glow"
              >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <Button
                ...
                className="mt-3 rounded-full vapor-bg text-white h-9 px-4 text-xs font-bold"
