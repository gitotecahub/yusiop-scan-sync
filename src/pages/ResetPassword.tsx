          ...
          {status === 'invalid' ? (
            <div className="text-center space-y-4">
              ...
              <Button
                ...
                className="w-full h-12 rounded-full vapor-bg text-white font-bold shadow-glow"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-12 rounded-full vapor-bg text-white hover:opacity-90 font-bold shadow-glow"
                disabled={submitting}
              >
